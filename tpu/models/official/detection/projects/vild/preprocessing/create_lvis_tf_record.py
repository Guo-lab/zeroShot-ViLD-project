...
#!
tf.app.flags.DEFINE_string('dest_dir', '/tmp', 'Path to output file')
...
def main(_):
  ...
  # *=========================================== 
  print("FLAGS.dest_dir: ", FLAGS.dest_dir)
  #all_filenames = [
  ...
  #]
  all_filenames = [
      osp.join(f'{FLAGS.split}-{part_idx:05}-of-{FLAGS.num_parts:05}.tfrecord')
      for part_idx in range(FLAGS.num_parts)
  ]
